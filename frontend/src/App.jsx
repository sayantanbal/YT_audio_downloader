...
function App() {
  ...
  const downloadAudio = async () => {
    ...
    try {
      ...
      const videoInfoResult = await youtubeAPI.getVideoInfo(url)
      
      if (videoInfoResult.success) {
        setVideoInfo({
          title: videoInfoResult.title,
          author: videoInfoResult.uploader,
          thumbnail: videoInfoResult.thumbnail,
          duration: videoInfoResult.duration,
          viewCount: videoInfoResult.view_count
        })
      } else {
        throw new Error(videoInfoResult.error || 'Failed to get video information')
      }

      // Start the download
      const downloadResult = await youtubeAPI.startDownload(url)
      
      if (downloadResult.success) {
        const newDownloadId = downloadResult.download_id
        setDownloadId(newDownloadId)

        // Poll for progress updates
        await youtubeAPI.pollDownloadProgress(
          newDownloadId,
          (progress) => {
            ...
            if (progress.status === 'downloading') {
              ...
              setDownloadProgress(99) // Almost complete
            }
          },
          1000 // Poll every second
        )

        // Download is complete, trigger file download
        setDownloadProgress(100)
        await youtubeAPI.downloadFile(newDownloadId)
        ...
        <div className="main-content">
          ...
          {backendStatus === 'offline' && (
            <div className="error-message">
              <span>⚠️ Backend service is offline. Please start the Python backend server first.</span>
            ...
            <div className="feature-grid">
              <div className="feature-item">
                ...
                <div>
                  ...
                  <p>Powered by yt-dlp for reliable downloads</p>
                </div>
              </div>
              <div className="feature-item">
                <span className="feature-icon">🎵</span>
          ...
          <div className="instructions">
            <h3>📋 How to use:</h3>
            <ol>
              <li>Make sure the Python backend is running (see setup instructions)</li>
              <li>Copy a YouTube video URL from your browser</li>
              <li>Paste it in the input field above</li>
              <li>Click the "Download Audio" button</li>
              <li>Wait for processing to complete</li>
              <li>Your MP3 file will be downloaded automatically</li>
            </ol>
